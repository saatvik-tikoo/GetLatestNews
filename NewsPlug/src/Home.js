...
export default class Home extends Component {
    ...
    componentDidMount() {
        ...
        if (val === "true") {
            url = 'http://ec2-54-197-200-149.compute-1.amazonaws.com:8000/api/guardian?section=home'
        } else {
            url = 'http://ec2-54-197-200-149.compute-1.amazonaws.com:8000/api/nytimes?section=home'
        }
        fetch(url)
            .then(res => res.json())
            .then((data) => {
